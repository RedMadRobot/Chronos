...
/**
 * Activity that can do a pre-defined operations and report its status.
 *
 * @author maximefimov
 */
public final class SimpleMockActivity extends MockActivity {

    private final static String OPERATION_TAG = "activity_operation_tag";
    ...
    public final boolean isRunning(final int id) {
        return isOperationRunning(id);
    }

    public final boolean isRunningTagged() {
        return isOperationRunning(OPERATION_TAG);
    }
