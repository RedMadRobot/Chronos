...
/**
 * Result of an {@link Operation} execution. Contain either
...
public abstract class OperationResult<ResultType> {
    ...
    @NonNull
    @Contract(pure = true)
    public final Operation<ResultType> getOperation() {
        return mOperation;
    }
     ...
     */
    final void setOperation(@NonNull final Operation<ResultType> operation) {
